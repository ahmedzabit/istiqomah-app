-- ISTIQOMAH Admin Setup - Additional Tables and Policies
-- Run this after the main setup is completed
...
-- UPDATE public.profiles SET is_admin = true WHERE email = 'admin@istiqomah.app';

-- Note: Uncomment and modify the line above with your admin email after creating the account
