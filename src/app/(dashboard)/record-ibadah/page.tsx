...
export default function RecordIbadahPage() {
  ...
  const loadHabitsForDate = async () => {
    ...
    try {
      // Get user's active ibadah for the selected date (with scheduling filter)
          ...
          <CardContent className="pt-6">
            <div className="text-center py-12">
              <h3 className="text-lg font-medium text-gray-900 mb-2">
                Tidak ada ibadah untuk tanggal ini
              </h3>
              <p className="text-gray-500 mb-6">
                Tidak ada ibadah yang dijadwalkan untuk {new Date(selectedDate).toLocaleDateString('id-ID', {
                  day: 'numeric',
                  month: 'long',
                  year: 'numeric'
                })}. Coba pilih tanggal lain atau tambahkan ibadah baru.
              </p>
        ...
        <div>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              ...
              <li>• Hanya ibadah yang dijadwalkan untuk tanggal ini yang akan muncul</li>
