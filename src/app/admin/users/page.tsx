                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center space-x-2">
                            <button
                              ...
                              className="px-3 py-1 rounded-lg text-xs font-medium transition-colors bg-blue-500/20 text-blue-400 hover:bg-blue-500/30 flex items-center space-x-1"
                            >
                ...
                {users.map((user) => (
                  <div key={user.id} className="bg-slate-700/50 rounded-lg p-4">
                    ...
                    <div className="flex space-x-2">
                      <button
                        onClick={() => setSelectedUser(user)}
                        className="flex-1 px-3 py-2 rounded-lg text-sm font-medium transition-colors bg-blue-500/20 text-blue-400 hover:bg-blue-500/30 flex items-center justify-center space-x-1"
                      >
      ...
      {selectedUser && (
        <UserDetailModal
          ...
          onAdminToggled={async () => {
            await toggleAdminStatus(selectedUser.id, selectedUser.is_admin);
